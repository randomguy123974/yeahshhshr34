        ...
        if g_toggle:
            ...
            while not unit_placed and g_toggle:
                ...
                if check_place:
                    ...
                    bt.click(x=409, y=352, delay=0.5)
                    time.sleep(0.5)
                    keyboard.press_and_release('1')
                    bt.click(x=409, y=352, delay=0.2)
                time.sleep(1)
            time.sleep(0.5)
            bt.click(382, 286)
            max_upgrade = False
            ...
            print("Max upgrade")
            wave_26 = False
            while not wave_26 and g_toggle:
            ...
            sukuna_nuke = False
            match_end = False
            while not sukuna_nuke and g_toggle:
                check_sukuna = bt.does_exist("Sukuna.png",0.8,True)
